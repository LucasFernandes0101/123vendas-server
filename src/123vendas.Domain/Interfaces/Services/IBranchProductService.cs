...
{
    Task<PagedResult<BranchProduct>> GetAllAsync(int? id, int? branchId, int? productId, bool? isActive, DateTimeOffset? startDate, DateTimeOffset? endDate, int page = 1, int maxResults = 10, string? orderByClause = default);
